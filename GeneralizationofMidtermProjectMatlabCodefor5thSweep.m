...
%% Let's generate Matrix, denoted by D_i_comma_j, to store the (Realized) Value(s) of D_[i,j](s) (Noisy Observation(s)),
...
%%%%%%%%%%%%%%%%% 1. For the First Image (FI) with 5th Sweep I[site]
...
%% for the 5th sweeping, and Sigma1 and Sigma2 are both 0.01 as follow:
